...
import com.faragostaresh.rtcguild.database.DatabaseHandler;
import com.faragostaresh.rtcguild.database.Story;
import com.faragostaresh.rtcguild.extra.ConnectionDetector;
import com.faragostaresh.rtcguild.extra.ImageLoader;
...
public class StoryActivity extends Activity {
	...
	public void onCreate(Bundle bundle) {
		...
		if (item.getBody().matches("")) {
			...
			// Image url
			String image_url = "http://www.rtcguild.com/uploads/news/image/medium/"
					+ item.getImage();
	...
	private class GetStory extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... ars) {
			...
			String url = "http://www.rtcguild.com/modules/news/ajax.php?op=singlestory&storyid="
					+ GetId;
			Log.d("Get URL", url);
