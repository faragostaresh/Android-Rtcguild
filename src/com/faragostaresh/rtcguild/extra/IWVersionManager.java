...
public interface IWVersionManager {
	...
	/**
	 * @param updateNowLabel
	 *            Set the label for update now button
	 */
	...
	/**
	 * @param remindMeLaterLabel
	 *            Set label of remind me later button
	 */
	...
	/**
	 * @param ignoreThisVersionLabel
	 *            Set label of ignore this version button
	 */
	public void setIgnoreThisVersionLabel(String ignoreThisVersionLabel);

	/**
	 * @param icon
	 *            Set drawable of icon in dialog
	 */
	...
	/**
	 * @return url to execute when update now button clicked. Default value is
	 *         the link in google play based on app package name.
	 */
	public String getUpdateUrl();

	/**
	 * @param updateUrl
	 *            Set url to execute when update now button clicked
	 */
	...
	/**
	 * @param versionContentUrl
	 *            Set the update content url
	 */
	public void setVersionContentUrl(String versionContentUrl);

	/**
	 * @param minutes
	 *            Set reminder time in minutes when remind me later button
	 *            clicked
	 */
	 ...
	 *            Set your own custom tag handler
	 */
